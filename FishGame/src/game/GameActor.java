...
public class GameActor {
	// size
		...
		Color 
			...
			color3=new Color(0,150,0), 
			color4=new Color(0,200,0);
		double colorHerz = 4;
		// Origin: 
		int origin;
		AudioClip ct;
		...
		public GameActor(double x, double y, boolean active, Species spec) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
			...
			this.ct=new AudioClip("src/sound16.wav");
			}
		}
